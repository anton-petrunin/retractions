...
A family of functions $f_t$ is called \emph{Lipschitz in space} if 
the function $(x,t)\mapsto f_t(x)$ is $L$-Lipschitz for some constant $L$.
It is called \emph{locally Lipschitz} if for each $(p_0,t_0)\in \Omega$ there is a neighborhood $\Omega'$ such that 
...
Suppose that $f_t$ is locally Lipschitz and locally uniformly semiconcave.
