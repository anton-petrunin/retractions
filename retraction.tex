...
\parbf{Motivation.}
In \cite[(4.1)]{kendall}, Wilfrid Kendall observed that if $\spc{B}$ is a regular geodesic ball or radius $r<\tfrac\pi2$ in a manifold with sectional curvature at most 1, then for an appropriate choice of constant $\lambda$, the following function
\[(x,y)\mapsto 
...
\parbf{Acknowledgements.} A. Lytchak was partially supported by the DFG grant SPP 2026.
