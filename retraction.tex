...
Then for any time moment $a$ and initial point $p\in \Dom f_a$ there is a unique $f$-gradient curve $t\mapsto\alpha(t)$ defined on a maximal semiopen interval $[a,b)$. 
...
Uniqueness of this curve follows from the distance estimate. 
